...
<html lang="en">
  ...
  <body>
	...
	<div class="card" style="width: 120rem;height:84rem;border-color:rgb(0, 255, 157) ;border-top-color: rgb(136, 132, 132);border-top-width: 1ch;">
		...
		<fieldset>
			<legend style="font-size:1.6em" align="left"><div class="shadow-lg p-3 mb-5 bg-white rounded">Applicant Details :</div></legend><br>
				<form action="./Database/birthdata.php" method="POST">
					...
					<hr><center><input id="submit" type="submit" name="submit" value="submit"></center>
					<br><br>
