...
<html lang="en">
  ...
  <body>
    <div class="card" style="width: 120rem;height:57rem;border-color:rgb(0, 255, 157) ;border-top-color: rgb(136, 132, 132);border-top-width: 1ch;">
		
		<div class="card-body">

    <div class="container">
    
        <h2 class="h2 text-center bg-dark ">Death Certificate Application Form Bengali:ডেথ সার্টিফিকেট আবেদনপত্র </h2><br>
